<?php require APPROOT . '/views/inc/header.php'; ?>
    <div class="site-blocks-cover" style="background-image: url(<?php echo URLROOT ?>/images/banner/banner0.jpg);" data-aos="fade">
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0 bg-light rounded shadow-sm">
            ...
            <div class="intro-text text-center text-md-left">
              ...
              <p>
                <a href="http://localhost:8080/web2/shops/index" class="btn btn-sm btn-primary">Shop Now</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 mb-5">
            <a href="#"><img src="<?php echo URLROOT; ?>/images/banner/banner1.jpg" alt="Image placeholder" class="img-fluid rounded"></a>
          </div>

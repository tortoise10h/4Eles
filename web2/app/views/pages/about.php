      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="<?php echo URLROOT; ?>/images/about/team-work.jpg" alt="Team work image" class="img-fluid rounded">
              </figure>
            </div>
          </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="<?php echo URLROOT; ?>/images/about/team-work.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Tan Huy</h3>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="<?php echo URLROOT; ?>/images/about/team-work.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Thuy An</h3>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="<?php echo URLROOT; ?>/images/about/team-work.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Anh Ngan</h3>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="<?php echo URLROOT; ?>/images/about/team-work.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Xuan Linh</h3>

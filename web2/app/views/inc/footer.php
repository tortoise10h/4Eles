        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              <img src="<?php echo URLROOT ?>/images/banner/banner0.jpg" alt="Image placeholder" class="img-fluid rounded mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Sai Gon University, 273 An Duong Vuong, District 5, Ho Chi Minh City</li>
                <li class="phone"><a href="tel://23923929210">0123456789</a></li>
                <li class="email">tortoise10h@domain.com</li>
